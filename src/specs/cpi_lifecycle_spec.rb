...
openstack_suite.context 'using the CPI', position: 2, order: :global do
  ...
  it 'can save and retrieve user-data from metadata service' do
    Validator::Api::skip_test('`config_drive` is configured in validator.yml.') if Validator::CfValidator.configuration.openstack['config_drive']
  ...
  it 'can save and retrieve user-data from config_drive' do
    Validator::Api::skip_test('`config_drive` is not configured in validator.yml.') unless Validator::CfValidator.configuration.openstack['config_drive']
